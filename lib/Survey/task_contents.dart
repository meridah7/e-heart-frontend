...
var question2 = MultipleChoiceQuestion(
...
var sampleSurvey = Survey(title: '1111 Survey', questions: [
  activityTimeQuestion,
  questionWithAdditionalOptions,
  questionWithoutAdditionalOptions,
  question3,
  sliderQuestion,
  question2
]);
...
var dietaryIntakeSurvey = Survey(title: '饮食日志', questions: [
  ...
  SingleChoiceQuestion(
      '属于哪一餐', ['早餐', '上午点心', '午餐', '下午点心', '晚餐', '夜宵', '零食', '饮料'], {}),
  ...
  SingleChoiceQuestion('在哪吃', ['家里', '学校', '工作地点', '餐馆', '外面', '其他'], {},
...
var mealPlanningSurvey = Survey(title: '每日饮食计划', questions: [
  ...
  MultipleChoiceQuestion(
    ...
    ],
    {
      ...
      '我感觉饱的感觉不太舒服': [
        SingleChoiceQuestion(
            '刚开始几天确实会这样，建议您尽量穿着宽松的衣物进食。过几天后这种感觉就会慢慢消失的！', ['好的！'], {})
      ],
      '一旦吃饱，我就会觉得自己吃太多了，我要减肥！': [
        SingleChoiceQuestion(
...
var bingeEatingReflectionSurvey = Survey(title: '冲动记录反思', questions: [
  SingleChoiceQuestion(
  ...
  SingleChoiceQuestion(
      '小E统计发现，您至今为止记录了**次暴食、清除冲动，并制定了相应的应对策略，您真的很棒！要继续坚持记录和应对哦。', ['了解了！'], {},
      description: ''),
  SingleChoiceQuestion(
...
var impulseRecordingSurvey = Survey(title: '冲动记录', questions: [
  ...
  TextQuestion('结合你的替代策略，制定你对这次冲动的应对方案', true, imageUrls: [
    'http://picture.gptkong.com/20240425/6ee7ca9254ab42ec84b0a13be39d683a.JPEG',
...
// 定义饮食日志教学反思Survey
var monitoringTeachingReflectionSurvey = Survey(title: '饮食日志反思', questions: [
  SingleChoiceQuestion(
  ...
  // 问题6
  SingleChoiceQuestion('您是否在最后一栏里记录了进食前后影响您饮食的想法和情绪', [
    '是',
    '否'
  ], {
    '否': [
...
ChartQuestion bingeEatingTimeChartQuestion = ChartQuestion('暴食次数与一天中的时间段',
    bingeEatingtimeOfDayChartData, QuestionType.None, [], ChartType.Bar,
    description: '分析一天中暴食发生的时间段。');

ChartQuestion bingeEatingLocationChartQuestion = ChartQuestion(
    '暴食次数与对应的地点', locationChartData, QuestionType.None, [], ChartType.Bar,
    orientation: ChartOrientation.horizontal, description: '分析暴食发生的地点。');
...
// 创建新的问卷
var regularDietReflectionSurvey = Survey(title: "饮食计划反思", questions: [
  SingleChoiceQuestion(
  ...
  SingleChoiceQuestion(
      ...
      ],
      {
        "0-5天": [
          TextQuestion(
              '小E知道坚持完成这个任务是个不容易的事情，因此没有每天进行饮食计划也完全没关系～您只需要想想干扰自己进行饮食日志记录的原因，并提出一些可能的改善策略就好啦。\n\n'
              '干扰原因',
              false),
...
ChartQuestion dietaryPlanChartQuestion = ChartQuestion("我有提前做好每天的饮食计划吗？",
    dietaryPlanChartData, QuestionType.None, [], ChartType.Bar,
...
ChartQuestion mealIntervalChartQuestion = ChartQuestion("我的饮食计划中的每餐间隔时间",
    mealIntervalChartData, QuestionType.None, [], ChartType.Bar,
    description: "");
