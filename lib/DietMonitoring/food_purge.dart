...
var foodPurgeSurvey = Survey(
  ...
  [
    ...
    TextQuestion('你采取了哪种方式清除食物？', true, description: '请尽可能详细地描述你采取的方法，例如：自我诱吐、使用泻药等。'),
    ...
    TextQuestion('发生前的饮食情况', true, description: '请描述在你决定清除食物前，你吃了什么，包括食物种类和大概的量。'),
    TextQuestion('清除后的感受', true, description: '请描述在你清除食物后，你的身体和情绪感受。'),
    TextQuestion('是否有触发因素？', true, description: '如果有，请描述是什么因素促使了这次食物清除行为。'),
    TextQuestion('更多注释（想法，感受等等）', true, description: '记录任何可能会影响你这次行为的东西，不管是你的纠结，想法还是情绪都可以。努力写一些！这一块的记录往往会在之后成为你改善行为的奇招！'),
  ]
);
